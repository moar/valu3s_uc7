...
class FridgeDisassemblyTest(unittest.TestCase):
    ...
    def test_fridge_not_openning(self):
        ...
        test_info = TestLaunchInfo(observation_model_name='FridgeDisassemblyOM.xml', task_id='f2b0da31-c5d5-4b16-b0e6-1d0e248a26a2', test_id='2')
        fake_test_result = DiagnosisTestResult(timestamp=123, situation_name='test_situation', step_name='Openning fridge', constraints='test_constarints', eval_result=False)
