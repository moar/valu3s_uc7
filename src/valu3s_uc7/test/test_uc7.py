...
class FridgeDisassemblyTest(unittest.TestCase):
    ...
    def test_fridge_not_openning(self):
        print("starting...")
        task = Task()
        time.sleep(1)
        print("started")
        ...
        with UlisesTestHelper(mqtt_host="172.17.6.163", test_launch_info=test_info, ignore_ack=True) as helper:
            ...
            # open fridge doors
            print(" - open fridge doors")
           # task.control_fridge_doors("fridge_00", ["up", "down"], True) Falla, no abre
            time.sleep(3)
    ...
    def test_pistons_01_not_closing(self):
        print("starting...")
        task = Task()
        time.sleep(1)
        print("started")
        ...
        with UlisesTestHelper(mqtt_host="172.17.6.163", test_launch_info=test_info, ignore_ack=True) as helper:
            ...
            # close pistons
            print(" - close pistons")
          #  task.control_piston("pistons_01", False) No se cierra piston 1
            task.control_piston("pistons_02", False)
            time.sleep(6)
            initial_waiting_thread.join()
            # open fridge doors
    ...
    def test_pistons_01_not_opening(self):
        print("starting...")
        task = Task()
        time.sleep(1)
        print("started")
        ...
        with UlisesTestHelper(mqtt_host="172.17.6.163", test_launch_info=test_info, ignore_ack=True) as helper:
            ...
            # open pistons
            print(" - open pistons")
          #  task.control_piston("pistons_01", True) No se abre piston 1
            task.control_piston("pistons_02", True)
            time.sleep(1)
    ...
    def test_pistons_02_not_opening(self):
        print("starting...")
        task = Task()
        time.sleep(1)
        print("started")
        ...
        with UlisesTestHelper(mqtt_host="172.17.6.163", test_launch_info=test_info, ignore_ack=True) as helper:
            ...
            print(" - open pistons")
            task.control_piston("pistons_01", True)
           # task.control_piston("pistons_02", True) No se abre piston 2
            time.sleep(1)
    ...
    def test_laser_not_working(self):
        print("starting...")
        task = Task()
        time.sleep(1)
        print("started")
    ...
    def test_conveyors_00(self):
        ...
        with UlisesTestHelper(mqtt_host="172.17.6.163", test_launch_info=test_info, ignore_ack=True) as helper:
            ...
            # move conveyors
            print(" - move conveyors")
            task.control_conveyor("conveyor_00", False)  # Conveyor_00 no se pone en marcha
            task.control_conveyor("conveyor_01", True)
            task.control_conveyor("conveyor_02", True)
            task.control_conveyor("conveyor_03", True)
    ...
    def test_conveyors_02(self):
        ...
        with UlisesTestHelper(mqtt_host="172.17.6.163", test_launch_info=test_info, ignore_ack=True) as helper:
            ...
            task.control_conveyor("conveyor_00", True)
            task.control_conveyor("conveyor_01", True)
            task.control_conveyor("conveyor_02", False) # Conveyor_02 no se pone en marcha
            task.control_conveyor("conveyor_03", True)
    ...
    def test_conveyors_03(self):
        ...
        with UlisesTestHelper(mqtt_host="172.17.6.163", test_launch_info=test_info, ignore_ack=True) as helper:
            ...
            task.control_conveyor("conveyor_01", True)
            task.control_conveyor("conveyor_02", True)
            task.control_conveyor("conveyor_03", False) # Conveyor_03 no se pone en marcha
